defmodule EmqxMediaRtp.RtpOpusEncoder do
  @moduledoc """
  ...
  @impl true
  def handle_stream_format(:input, stream_format, _ctx, _state) do
    raise """
    Changing input sample rate or channels is not supported: #{inspect(stream_format)}
    """
  end
